...
solarSystem[6].moons[solarSystem[6].moons.indexOf("Umbriel")] = "Oberon";
...
const totalSatellites3 = satellitesArray.reduce((total, num) => total + num, 0);
console.log(totalSatellites3);
